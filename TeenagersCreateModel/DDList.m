...
- (void)viewDidLoad {
   ...
   // self.tableView.backgroundColor = [ColorUtil colorWithHexString:@"eeeeee"];
	...
	_resultList = @[@{@"identfy":@"JSYH",@"name":@"建设银行"}];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	cell.textLabel.text = [[_resultList objectAtIndex:row] objectForKey:@"name"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	[_delegate passValue:[[_resultList objectAtIndex:[indexPath row]] objectForKey:@"name"]];
    [_delegate passBankCode:[[_resultList objectAtIndex:[indexPath row]] objectForKey:@"identfy"]];
